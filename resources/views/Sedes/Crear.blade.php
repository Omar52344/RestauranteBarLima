...
<body>
    ...
    <div class="container content-invoice">
        ...
        <form action="/CrearSede" id="invoice-form" method="POST" class="invoice-form" role="form">
            @csrf
                        ...
                        <table class="table table-bordered table-hover" id="">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="Descripcion" id="" class="form-control" autocomplete="off"
                                        value="" required></td>
                                <td><input type="text" name="Direccion" id="" class="form-control quantity" value=""
